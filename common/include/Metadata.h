...
#define META_NAME			"Nintendont (Prime Edition)"
#define META_AUTHOR			"FIX94, crediar"

#define META_LONG1			"Commiters: GerbilSoft, JoostinOnline, GreyRogue, Howard, Cyan, Pwootage \r\n\r\n Project website: https://github.com/FIX94/Nintendont "
#define META_LONG2			"Nintendont allows you to run GameCube games on a Wii or Wii U from an SD or HDD device. \r\nThis version has modifications which allow you to dump Prime memory over the network"
